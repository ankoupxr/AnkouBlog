...
namespace AnkouBlog.Repository.sugar
{
    public class DbContext
    {
        private static string _connectionString;
        private static DbType __dbType;
        private SqlSugarClient __db;
        ...
        private DbContext()
        {
            ...
            __db = new SqlSugarClient(new ConnectionConfig()
            {
        ...
        {
            return new SimpleClient<T>(__db);
        }
        /// <summary>
        /// 功能描述:获取数据库处理对象
        /// </summary>
        /// <param name="_db">_db</param>
        /// <returns>返回值</returns>
        public SimpleClient<T> GetEntityDB<T>(SqlSugarClient _db) where T : class, new()
        {
          ...
          bool blnSerializable = false)
        {
            ...
            {
                __db.DbFirst.Where(lstTableNames).IsCreateDefaultValue().IsCreateAttribute()
...
")
            ...
            {
                __db.DbFirst.IsCreateAttribute().IsCreateDefaultValue()
                    .SettingClassTemplate(p => p = @"
{using}
...
")
        ...
        public void CreateTableByEntity(bool blnBackupTable, params Type[] lstEntitys)
        {
            if (blnBackupTable)
            {
                __db.CodeFirst.BackupTable().InitTables(lstEntitys); //change entity backupTable            
            }
            else
            {
                __db.CodeFirst.InitTables(lstEntitys);
            }
        }
        #endregion
